...
parser = argparse.ArgumentParser(description='MsMoE')

# basic config
parser.add_argument('--task_name', type=str, default='long_term_forecast',
                    help='task name, options:[long_term_forecast, short_term_forecast, imputation, classification, anomaly_detection]')
parser.add_argument('--is_training', type=int, default=1, help='status')
parser.add_argument('--model_id', type=str, default='msmoe_etth1', help='model id')
parser.add_argument('--model', type=str, default='MsMoE',
                    help='model name, options: [MsMoE]')
...
if __name__ == '__main__':
    ...
    data_file = os.path.join(args.root_path, args.data_path) if args.root_path and args.data_path else None
    if args.task_name in ['long_term_forecast', 'short_term_forecast'] and data_file and not os.path.exists(data_file):
